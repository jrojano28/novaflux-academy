...
class CourseService:
    ...
    def execute_playground_code(code):
        """
        Ejecuta código básico de Python de manera restringida para propósitos educativos.
        """
        import sys
        import io
        ...
        # Validaciones de seguridad muy básicas
        ...
        try:
            # Definir un entorno de variables seguras
            safe_globals = {
                "print": print,
                "range": range,
                "len": len,
